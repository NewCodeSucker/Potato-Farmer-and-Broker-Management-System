...
--
-- Table structure for table `farmlnad`
--

DROP TABLE IF EXISTS `farmlnad`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `farmlnad` (
...
--
-- Dumping data for table `farmlnad`
--

LOCK TABLES `farmlnad` WRITE;
/*!40000 ALTER TABLE `farmlnad` DISABLE KEYS */;
/*!40000 ALTER TABLE `farmlnad` ENABLE KEYS */;
UNLOCK TABLES;
